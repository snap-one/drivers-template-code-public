--[[=============================================================================
    Command Functions Received From Receiver Proxy to the Driver
...
if (TEMPLATE_VERSION ~= nil) then
	TEMPLATE_VERSION.receiver_proxy_commands = "2022.05.12"
end
...
function PRX_CMD.SET_SURROUND_MODE(idBinding, tParams)
	LogTrace("PRX_CMD.SET_SURROUND_MODE")
	ProxyInstance(idBinding):PrxSetSurroundMode(tParams)
end


function PRX_CMD.PULSE_SUR_UP(idBinding, tParams)
	LogTrace("PRX_CMD.PULSE_SUR_UP")
	ProxyInstance(idBinding):PrxPulseSurUp(tParams)
end
